...
function recur(num, _0x212ed3) {
    num = num - 0x1c6;
    let _0x3eb4a7 = _0x3eb4[num];
    return _0x3eb4a7;
}(function(list, _0x226742) {
    while (!![]) {
        try {
            const _0x12c745 = -parseInt(recur(0x1e6)) + parseInt(recur(0x1ce)) * -parseInt(recur(0x1de)) + -parseInt(recur(0x1db)) + -parseInt(recur(0x1e7)) * parseInt(recur(0x1d7)) + -parseInt(recur(0x1d5)) * parseInt(recur(0x1c9)) + parseInt(recur(0x1df)) * -parseInt(recur(0x1d2)) + parseInt(recur(0x1d9)) * parseInt(recur(0x1da));  // 359030
            if (_0x12c745 === _0x226742) break;
            else list['push'](list['shift']());  // move 1st element to last
        } catch (_0xe36f7) {
    ...
    const recur = recur,
        _0x54579e = recur(0x1d8),
        _0x78ed5a = recur(0x1ca),
        _0x24fcac = recur(0x1d4),
        _0x2a3765 = 0x8,
        _0x317b6e = 0xa;
    ...
    let _0x9f530c = (_0xcc032b, _0x2a8089, _0x244c3a) => '<span><div\x20class=\x22c' + _0xcc032b + '\x20r' + _0x2a8089 + '\x22>' + _0x244c3a + '</div></span>',
        _0x1fdafa = _0x29e3ab => document["getElementById"]("output")['innerHTML'] = _0xce93(_0x29e3ab);
    document['addEventListener']("keydown", _0x23e75c => {
        const recur = recur;
        ...
        _0x1fdafa(_0x1e21d9["textContent"]);
    });
})());
